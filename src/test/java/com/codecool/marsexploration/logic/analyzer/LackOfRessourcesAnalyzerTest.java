...
class LackOfRessourcesAnalyzerTest {

    public static Stream<Arguments> dataForAnalyzeTest() {
        return Stream.of(
                Arguments.of(4, 2, 2, null),
                Arguments.of(4, 3, 3, null),
                Arguments.of(5, 3, 3, null),
                Arguments.of(5, 3, 2, null),
                Arguments.of(5, 2, 2, Outcome.NOT_COLONIZABLE_RESOURCES),
                Arguments.of(6, 0, 0, Outcome.NOT_COLONIZABLE_RESOURCES),
                Arguments.of(6, 3, 2, null),
                Arguments.of(6, 3, 3, null)
        );
    }

    @ParameterizedTest
    @MethodSource("dataForAnalyzeTest")
    void analyzeTest(int stepsToSet, int waterToSet, int mineralToSet, Outcome expected) {
        ...
        LackOfRessourcesAnalyzer analyzer = new LackOfRessourcesAnalyzer();
